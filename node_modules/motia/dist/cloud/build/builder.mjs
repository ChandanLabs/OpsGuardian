//#region src/cloud/build/builder.ts
var Builder = class {
	constructor(projectDir, listener) {
		this.projectDir = projectDir;
		this.listener = listener;
		this.stepCompressedSizes = /* @__PURE__ */ new Map();
		this.stepUncompressedSizes = /* @__PURE__ */ new Map();
		this.routerCompressedSizes = /* @__PURE__ */ new Map();
		this.routerUncompressedSizes = /* @__PURE__ */ new Map();
	...
	determineStepType(step) {
		if (step.config.type === "noop") return "noop";
		else if (step.filePath.endsWith(".ts") || step.filePath.endsWith(".js")) return "node";
		else if (step.filePath.endsWith(".py")) return "python";
		else if (step.filePath.endsWith(".rb")) return "ruby";
		return "unknown";
	}
};
