import { BUNDLE_SIZE_LIMITS, BYTES_TO_MB } from "./constants.mjs";
import pc from "picocolors";

//#region src/cloud/build/validations/router-bundle-sizes.validator.ts
const routerBundleSizesValidator = (builder) => {
	const errors = [];
	const maxRouterSize = BUNDLE_SIZE_LIMITS.ROUTER_MAX_MB * BYTES_TO_MB;
	for (const [routerType, uncompressedSize] of builder.routerUncompressedSizes.entries()) if (uncompressedSize > maxRouterSize) {
...
//#endregion
export { routerBundleSizesValidator };
//# sourceMappingURL=router-bundle-sizes.validator.mjs.map