import { BuildPrinter } from "./build-printer.mjs";
import { printDeploymentStatus } from "./print-deployment-status.mjs";
import { DeployPrinter } from "./printer.mjs";
import pc from "picocolors";

//#region src/cloud/new-deployment/listeners/cli-listener.ts
var CliListener = class {
	constructor(context) {
		this.context = context;
		this.deployPrinter = new DeployPrinter();
	...
	onDeployError(errorMessage) {
		this.context.log("deploy-result", (message) => message.tag("failed").append("Deployment failed. Please check the deployment status and try again or contact support", "red").box([errorMessage], "red"));
	}
	stepUploadProgress() {}
	routeUploadProgress() {}
	routeUploadError() {}
...
//#endregion
export { CliListener };
//# sourceMappingURL=cli-listener.mjs.map