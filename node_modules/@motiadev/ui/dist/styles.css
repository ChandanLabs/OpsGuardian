...
@layer utilities {
  ...
  .outline-\[\#2862FE\]\/20 {
    outline-color: color-mix(in oklab, #2862FE 20%, transparent);
  }
  .outline-\[\#E22A6D\]\/20 {
    outline-color: color-mix(in oklab, #E22A6D 20%, transparent);
  }
  .outline-\[\#F59F0B\]\/20 {
    outline-color: color-mix(in oklab, #F59F0B 20%, transparent);
  }
  .backdrop-blur {
  ...
  .data-\[state\=active\]\:after\:w-\[calc\(100\%-2\.5rem\)\] {
    &[data-state="active"] {
      &::after {
        content: var(--tw-content);
